...
float GetTemperature() {
  ...
  float tempVoltage = (tempReading * 5.0) / 1105.0;
...
void loop(void) {
  ...
  // DateTime now;
  // String date = toHumanReadableDate(now); <-- had this code in previous version to check if shield was getting correct
  // Serial.println(date);                        time and date. all it would say was 01/01/2000 Saturday 00:00:00
